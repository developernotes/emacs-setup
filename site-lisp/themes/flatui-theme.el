...
;;;;; basic coloring
   ...
   `(fringe ((t (:foreground ,wet-asphalt :background ,clouds))))
...
;;;;; eshell
   `(eshell-prompt ((t (:foreground ,asbestos :weight bold))))
...
;;;;; linum-mode
   `(linum ((t (:foreground ,wet-asphalt :background ,clouds))))
;;;;; magit
   ...
   `(mode-line-inactive
     ((t (:inverse-video unspecified
                         ...
                         :box (:line-width 1
                                           :color ,silver
                                           :style unspecified)))))
   `(mode-line-buffer-id ((t (:foreground ,lime :weight bold))))
