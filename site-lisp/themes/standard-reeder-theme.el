;;; standard-reeder-theme.el --- Custom face theme for Emacs
...
(deftheme standard-reeder
  "Standard reder light color theme")

(custom-theme-set-faces
 'standard-reeder
 '(default ((t (:background "#F8F7F5" :foreground "#000000"))))
 '(cursor ((t (:background "#000000" :foreground "#ffffff"))))
 '(region ((t (:background "#eedc82"))))
`(mode-line ((t (:box (:line-width 1 :color "#595959")
                         :background "#F1EFE9" :foreground "#595959"))))
 `(mode-line-inactive ((t (:box (:line-width 1 :color "#505050")
                                  :background "#F1EFE9" :foreground "#c6c6c6")))) 
 '(fringe ((t (:background "#F8F7F5"))))
...
(provide-theme 'standard-reeder)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; standard-reeder-theme.el  ends here
