...
;; A port of the Gruvbox light colorscheme for Vim, built on top of the new
...
(deftheme gruvbox-light "A retro-groove light colour theme")
(let ((gruvbox-dark0_hard  (if (display-graphic-p) "#f9f5d7" "color-234"))
      (gruvbox-dark0       (if (display-graphic-p) "#fbf1c7" "color-235"))
      (gruvbox-dark0_soft  (if (display-graphic-p) "#f2e5bc" "color-236"))
      (gruvbox-dark1       (if (display-graphic-p) "#ebdbb2" "color-237"))
      (gruvbox-dark2       (if (display-graphic-p) "#d5c4a1" "color-239"))
      (gruvbox-dark3       (if (display-graphic-p) "#bdae93" "color-241"))
      (gruvbox-dark4       (if (display-graphic-p) "#a89984" "color-243"))
      ...
      (gruvbox-light1      (if (display-graphic-p) "#3c3836" "color-223"))
      (gruvbox-light2      (if (display-graphic-p) "#504945" "color-250"))
      (gruvbox-light3      (if (display-graphic-p) "#665c54" "color-248"))
      (gruvbox-light4      (if (display-graphic-p) "#7c6f64" "color-246"))

      (gruvbox-bright_red     (if (display-graphic-p) "#cc241d" "color-167"))
      (gruvbox-bright_green   (if (display-graphic-p) "#98971a" "color-142"))
      (gruvbox-bright_yellow  (if (display-graphic-p) "#d79921" "color-214"))
      (gruvbox-bright_blue    (if (display-graphic-p) "#458588" "color-109"))
      (gruvbox-bright_purple  (if (display-graphic-p) "#b16286" "color-175"))
      (gruvbox-bright_aqua    (if (display-graphic-p) "#689d6a" "color-108"))
      (gruvbox-bright_orange  (if (display-graphic-p) "#d65d0e" "color-208"))
  ...
  (custom-theme-set-faces
   ...
   ;; Eshell
   `(eshell-prompt ((t (:foreground ,gruvbox-neutral_green))))
